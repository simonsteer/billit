...
export default function Layout({ children }: LayoutProps<'/'>) {
  return (
    <div className="p-12 flex flex-col fixed inset-0">
      ...
      <main className="border border-neutral-400 rounded-lg relative z-0 flex-1 bg-white px-24 w-full max-w-screen-xl mx-auto overflow-y-scroll no-scrollbar shadow-lg">
